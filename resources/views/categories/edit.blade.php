...
@section('breadcrumbs')
    {{ Breadcrumbs::render('edit_title_category', $category) }}
@endsection
                    ...
                    <form action="{{ route('categories.update', ['category' => $category]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="input_category_slug" value="{{ old('slug', $category->slug) }}" name="slug"
                                ...
                                placeholder="Masukkan Slug"readonly />
                            @error('slug')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="input_category_thumbnail" name="thumbnail"
                                    ...
                                    class="form-control @error('thumbnail') is-invalid @enderror" placeholder="" readonly />
                                @error('thumbnail')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="input_category_description" name="description"
                                class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="Masukkan Deskripsi">{{ old('description', $category->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
